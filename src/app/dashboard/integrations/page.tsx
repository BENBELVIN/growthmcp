...
export default function IntegrationsPage() {
  return (
    <>
      <DashboardHeader
        title="Integrations"
        description="Connect the growth sources your agent needs"
      />
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Start with Search Console and Trends. That&apos;s enough for
              Cursor to give useful growth recommendations.
            </p>
          </div>
