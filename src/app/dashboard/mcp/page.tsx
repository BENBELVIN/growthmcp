...
export default function McpPage() {
  return (
    <>
      <DashboardHeader title="MCP" description="Connect GrowthMCP to Cursor" />
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Add GrowthMCP as an MCP server so Cursor can pull growth context
              and recommend what to improve.
            </p>
          </div>
